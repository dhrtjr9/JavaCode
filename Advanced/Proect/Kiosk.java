...
class Kiosk extends JFrame implements ActionListener{
   ...
   void setPanel(){
    ...
    pSp.setBackground(Color.ORANGE);
     ...
     c1.setFont(new Font("맑은고딕", Font.BOLD, 14));
     c2.setFont(new Font("맑은고딕", Font.BOLD, 14));
     c3.setFont(new Font("맑은고딕", Font.BOLD, 14));
     c4.setFont(new Font("맑은고딕", Font.BOLD, 14));
     c5.setFont(new Font("맑은고딕", Font.BOLD, 14));
